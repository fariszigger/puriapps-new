...
@section('breadcrumb-items')
    ...
    <li class="inline-flex items-center">
        <div class="flex items-center">
            ...
            <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">Edit Evaluasi</span>
        </div>
    </li>
...
@section('content')
    ...
    <div x-data="evaluationForm"
        ...
        <div
            ...
            <h1 class="text-3xl font-bold tracking-tight text-gray-900 mb-6">Edit Evaluasi</h1>
            ...
            @if(isset($readonly) && $readonly)
                <div class="p-4 mb-4 text-sm text-blue-800 rounded-lg bg-blue-50 border border-blue-200 flex items-center gap-3"
                    ...
                    <div>
                        <span class="font-bold">Mode Tinjau</span> — Anda sedang meninjau evaluasi ini. Semua data bersifat
                        hanya-baca.
                    </div>
                </div>
            @endif
            ...
            <ol
                ...
                <li class="flex items-center whitespace-nowrap cursor-pointer" @click="currentStep = 6"
                    ...
                    <span :class="currentStep === 6 ? 'font-bold' : ''">Scoring</span>
                    <svg class="w-3 h-3 mx-4 text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                        fill="none" viewBox="0 0 12 10">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="m7 9 4-4-4-4M1 9l4-4-4-4" />
            ...
            <form id="evaluation-form" method="POST" action="{{ route('evaluations.update', $evaluation->id) }}"
                                ...
                                <div>
                                    ...
                                    <select id="office_branch" name="office_branch"
                                        ...
                                        @foreach($aoUsers->pluck('office_branch')->unique() as $branch)
                                            <option value="{{ $branch }}" {{ ($loggedInAo && $loggedInAo->office_branch == $branch) ? 'selected' : (old('office_branch', $evaluation->office_branch) == $branch ? 'selected' : '') }}>
                                                {{ $branch }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div>
                                    ...
                                    <select id="user_id" name="user_id"
                                        ...
                                        @foreach($aoUsers as $ao)
                                            <option value="{{ $ao->id }}" {{ ($loggedInAo && $loggedInAo->id == $ao->id) ? 'selected' : (old('user_id', $evaluation->user_id) == $ao->id ? 'selected' : '') }}>
                                                {{ $ao->name }} - ({{ $ao->code }})
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10">
                                <div class="col-span-1 md:col-span-3">
                                    ...
                                    <select id="loan_type" name="loan_type" x-model="loanType"
                                        ...
                                        required>
                                        <option value="Pinjaman Angsuran" {{ old('loan_type', $evaluation->loan_type) == 'Pinjaman Angsuran' ? 'selected' : '' }}>Pinjaman
                                            Angsuran</option>
                                        <option value="Pinjaman Musiman" {{ old('loan_type', $evaluation->loan_type) == 'Pinjaman Musiman' ? 'selected' : '' }}>Pinjaman
                                            Musiman</option>
                                        <option value="Pinjaman Anuitas" {{ old('loan_type', $evaluation->loan_type) == 'Pinjaman Anuitas' ? 'selected' : '' }}>Pinjaman
                                            Anuitas</option>
                                    </select>
                                </div>
                                ...
                                <div
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="loan_purpose" name="loan_purpose"
                                            value="{{ old('loan_purpose', $evaluation->loan_purpose) }}"
                                            class="bg-white border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-blue-500 focus:border-blue-500 block w-full p-3 shadow-sm transition-colors hover:border-blue-400"
                                    ...
                                    <div x-show="loanType === 'Pinjaman Musiman'">
                                        ...
                                        <input type="text" id="seasonal_loan_repayment_source"
                                            ...
                                            value="{{ old('seasonal_loan_repayment_source', $evaluation->seasonal_loan_repayment_source) }}"
                                            class="bg-white border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-blue-500 focus:border-blue-500 block w-full p-3 shadow-sm transition-colors hover:border-blue-400"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10">
                                <div class="col-span-1 md:col-span-3">
                                    ...
                                    <select id="old_loan_type" name="old_loan_type" x-model="oldLoanType"
                                        ...
                                        required>
                                        <option value="Pinjaman Angsuran" {{ old('old_loan_type', $evaluation->old_loan_type) == 'Pinjaman Angsuran' ? 'selected' : '' }}>Pinjaman
                                            Angsuran</option>
                                        <option value="Pinjaman Musiman" {{ old('old_loan_type', $evaluation->old_loan_type) == 'Pinjaman Musiman' ? 'selected' : '' }}>Pinjaman
                                            Musiman</option>
                                    </select>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" id="old_loan_amount_display" x-model="displayOldLoanAmount"
                                            ...
                                            value="{{ old('old_loan_amount', number_format($evaluation->old_loan_amount, 0, ',', '.')) }}"
                                        ...
                                        <input type="hidden" name="old_loan_amount" x-model="oldLoanAmount"
                                            value="{{ old('old_loan_amount', $evaluation->old_loan_amount) }}">
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="number" id="old_loan_term_months" name="old_loan_term_months"
                                        ...
                                        value="{{ old('old_loan_term_months', $evaluation->old_loan_term_months) }}"
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="number" step="0.01" id="old_loan_interest_rate"
                                            ...
                                            value="{{ old('old_loan_interest_rate', $evaluation->old_loan_interest_rate) }}"
                                            class="bg-white border border-gray-300 text-gray-900 text-lg rounded-xl focus:ring-amber-500 focus:border-amber-500 block w-full p-2.5 shadow-sm font-semibold transition-colors hover:border-amber-400 text-center"
                                            required placeholder="Contoh: 12">
                                        <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                            <span class="text-gray-500 font-bold">%</span>
                                ...
                                <div
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="old_loan_purpose" name="old_loan_purpose"
                                            value="{{ old('old_loan_purpose', $evaluation->old_loan_purpose) }}"
                                            class="bg-white border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-amber-500 focus:border-amber-500 block w-full p-3 shadow-sm transition-colors hover:border-amber-400"
                                            placeholder="Contoh: Menambah modal dagang sembako">
                                    </div>
                                    <div x-show="oldLoanType === 'Pinjaman Musiman'">
                                        ...
                                        <input type="text" id="old_seasonal_loan_repayment_source"
                                            ...
                                            value="{{ old('old_seasonal_loan_repayment_source', $evaluation->old_seasonal_loan_repayment_source) }}"
                                            class="bg-white border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-amber-500 focus:border-amber-500 block w-full p-3 shadow-sm transition-colors hover:border-amber-400"
                                            placeholder="Contoh: Hasil panen padi">
                                    </div>
                                </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                                <div class="col-span-1 md:col-span-3 relative">
                                    ...
                                    <input type="text" id="search_economic_sector" x-model="searchEconomicSector"
                                        @input="selectedEconomicSector = null"
                                        class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 shadow-sm"
                                ...
                                <div class="col-span-1">
                                    ...
                                    <input type="text" id="economic_sector_code" name="economic_sector_code"
                                        :value="selectedEconomicSector?.code" readonly
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                                ...
                                <div class="col-span-1">
                                    ...
                                    <input type="text" id="non_bank_third_party_code" name="non_bank_third_party_code"
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <textarea id="customer_profile" name="customer_profile" rows="3"
                                        class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 shadow-sm"
                                        placeholder="Contoh: Pedagang sate ayam sejak 2010 dengan lokasi menetap.">{{ old('customer_profile', $evaluation->customer_profile) }}</textarea>
                                </div>
                                <div>
                                    ...
                                    <input type="number" id="customer_dependents" name="customer_dependents"
                                        value="{{ old('customer_dependents', $evaluation->customer_dependents) }}"
                                        class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 shadow-sm"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <select id="customer_entreprenuership_ownership"
                                        ...
                                        class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 shadow-sm"
                                        :required="entrepreneurshipStatus === 'Wirausaha'">
                                        <option value="" disabled {{ old('customer_entreprenuership_ownership', $evaluation->customer_entreprenuership_ownership) ? '' : 'selected' }}>Pilih
                                        </option>
                                        <option value="Milik Sendiri" {{ old('customer_entreprenuership_ownership', $evaluation->customer_entreprenuership_ownership) == 'Milik Sendiri' ? 'selected' : '' }}>Milik Sendiri</option>
                                        <option value="Milik Keluarga" {{ old('customer_entreprenuership_ownership', $evaluation->customer_entreprenuership_ownership) == 'Milik Keluarga' ? 'selected' : '' }}>Milik Keluarga</option>
                                        <option value="Usaha Patungan" {{ old('customer_entreprenuership_ownership', $evaluation->customer_entreprenuership_ownership) == 'Usaha Patungan' ? 'selected' : '' }}>Usaha Patungan</option>
                                        <option value="Usaha Warisan" {{ old('customer_entreprenuership_ownership', $evaluation->customer_entreprenuership_ownership) == 'Usaha Warisan' ? 'selected' : '' }}>Usaha Warisan</option>
                                        <option value="Kepemilikan Saham" {{ old('customer_entreprenuership_ownership', $evaluation->customer_entreprenuership_ownership) == 'Kepemilikan Saham' ? 'selected' : '' }}>Kepemilikan Saham</option>
                                        <option value="Lainnya" {{ old('customer_entreprenuership_ownership', $evaluation->customer_entreprenuership_ownership) == 'Lainnya' ? 'selected' : '' }}>Lainnya</option>
                                    </select>
                                </div>
                                <div class="col-span-1 md:col-span-2">
                                    ...
                                    <input type="text" id="customer_entreprenuership_name"
                                        ...
                                        value="{{ old('customer_entreprenuership_name', $evaluation->customer_entreprenuership_name) }}"
                                        class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 shadow-sm">
                                </div>
                                <div>
                                    ...
                                    <input type="text" id="customer_entreprenuership_type"
                                        ...
                                        value="{{ old('customer_entreprenuership_type', $evaluation->customer_entreprenuership_type) }}"
                                        class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 shadow-sm"
                                ...
                                <div>
                                    ...
                                    <input type="text" id="customer_entreprenuership_products"
                                        ...
                                        value="{{ old('customer_entreprenuership_products', $evaluation->customer_entreprenuership_products) }}"
                                        class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 shadow-sm"
                                ...
                                <div>
                                    ...
                                    <input type="text" id="customer_entreprenuership_place_status"
                                        ...
                                        value="{{ old('customer_entreprenuership_place_status', $evaluation->customer_entreprenuership_place_status) }}"
                                        class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 shadow-sm"
                                ...
                                <div>
                                    ...
                                    <input type="text" id="customer_entreprenuership_phone"
                                        ...
                                        value="{{ old('customer_entreprenuership_phone', $evaluation->customer_entreprenuership_phone) }}"
                                        class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 shadow-sm"
                                ...
                                <div>
                                    ...
                                    <input type="number" id="customer_entreprenuership_employee_count"
                                        ...
                                        value="{{ old('customer_entreprenuership_employee_count', $evaluation->customer_entreprenuership_employee_count) }}"
                                        class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 shadow-sm"
                                ...
                                <div>
                                    ...
                                    <input type="text" id="customer_entreprenuership_year"
                                        ...
                                        value="{{ old('customer_entreprenuership_year', $evaluation->customer_entreprenuership_year) }}"
                                        class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 shadow-sm">
                                </div>
                                <div class="col-span-1 md:col-span-2">
                                    ...
                                    <textarea id="customer_entreprenuership_description"
                                        ...
                                        class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 shadow-sm"
                                        placeholder="Penjelasan detail mengenai usaha">{{ old('customer_entreprenuership_description', $evaluation->customer_entreprenuership_description) }}</textarea>
                                </div>
                                ...
                                <div x-show="legality === 'Berbadan Usaha'"
                                    ...
                                    <div class="space-y-3">
                                        <input type="text" id="customer_entreprenuership_tax_id"
                                            ...
                                            value="{{ old('customer_entreprenuership_tax_id', $evaluation->customer_entreprenuership_tax_id) }}"
                                        ...
                                        <input type="text" id="customer_entreprenuership_legality_id"
                                            ...
                                            value="{{ old('customer_entreprenuership_legality_id', $evaluation->customer_entreprenuership_legality_id) }}"
                                            class="bg-white border border-gray-300 text-gray-900 text-xs rounded-lg block w-full p-2.5"
                                        ...
                                        <input type="text" id="customer_entreprenuership_legality_register_id"
                                            ...
                                            value="{{ old('customer_entreprenuership_legality_register_id', $evaluation->customer_entreprenuership_legality_register_id) }}"
                                            class="bg-white border border-gray-300 text-gray-900 text-xs rounded-lg block w-full p-2.5"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="col-span-1 md:col-span-2">
                                    ...
                                    <input type="text" id="customer_company_name" name="customer_company_name"
                                        value="{{ old('customer_company_name', $evaluation->customer_company_name) }}"
                                        class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 shadow-sm"
                                ...
                                <div class="col-span-1 md:col-span-2">
                                    ...
                                    <input type="text" id="customer_company_address" name="customer_company_address"
                                        value="{{ old('customer_company_address', $evaluation->customer_company_address) }}"
                                        class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 shadow-sm"
                                ...
                                <div>
                                    ...
                                    <input type="text" id="customer_company_position" name="customer_company_position"
                                        value="{{ old('customer_company_position', $evaluation->customer_company_position) }}"
                                        class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 shadow-sm"
                                ...
                                <div>
                                    ...
                                    <input type="text" id="customer_company_years" name="customer_company_years"
                                        value="{{ old('customer_company_years', $evaluation->customer_company_years) }}"
                                        class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 shadow-sm"
                                ...
                                <div class="col-span-1 md:col-span-2">
                                    ...
                                    <input type="text" id="customer_company_phone" name="customer_company_phone"
                                        value="{{ old('customer_company_phone', $evaluation->customer_company_phone) }}"
                                        class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 shadow-sm"
                                ...
                                <div class="col-span-1 md:col-span-2">
                                    ...
                                    <select id="customer_employee_status" name="customer_employee_status"
                                        ...
                                        <option value="Pegawai Tetap" {{ old('customer_employee_status', $evaluation->customer_employee_status) == 'Pegawai Tetap' ? 'selected' : '' }}>
                                            Pegawai Tetap</option>
                                        <option value="Pegawai Kontrak" {{ old('customer_employee_status', $evaluation->customer_employee_status) == 'Pegawai Kontrak' ? 'selected' : '' }}>
                                            Pegawai Kontrak</option>
                                        <option value="Pegawai Honorer" {{ old('customer_employee_status', $evaluation->customer_employee_status) == 'Pegawai Honorer' ? 'selected' : '' }}>
                                            Pegawai Honorer</option>
                                        <option value="Pegawai Paruh Waktu" {{ old('customer_employee_status', $evaluation->customer_employee_status) == 'Pegawai Paruh Waktu' ? 'selected' : '' }}>Pegawai Paruh Waktu</option>
                                        <option value="Pegawai Musiman" {{ old('customer_employee_status', $evaluation->customer_employee_status) == 'Pegawai Musiman' ? 'selected' : '' }}>
                                            Pegawai Musiman</option>
                                        <option value="Pegawai Lepas" {{ old('customer_employee_status', $evaluation->customer_employee_status) == 'Pegawai Lepas' ? 'selected' : '' }}>
                                            Pegawai Lepas</option>
                                    </select>
                                </div>
                                <div>
                                    ...
                                    <input type="text" id="customer_company_sector" name="customer_company_sector"
                                        value="{{ old('customer_company_sector', $evaluation->customer_company_sector) }}"
                                        class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 shadow-sm"
                                ...
                                <div>
                                    ...
                                    <input type="text" id="customer_company_employee_count"
                                        ...
                                        value="{{ old('customer_company_employee_count', $evaluation->customer_company_employee_count) }}"
                                        class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 shadow-sm"
                                ...
                                <div>
                                    ...
                                    <select id="customer_company_salary_frequency" name="customer_company_salary_frequency"
                                        ...
                                        <option value="Harian" {{ old('customer_company_salary_frequency', $evaluation->customer_company_salary_frequency) == 'Harian' ? 'selected' : '' }}>
                                            Harian</option>
                                        <option value="Mingguan" {{ old('customer_company_salary_frequency', $evaluation->customer_company_salary_frequency) == 'Mingguan' ? 'selected' : '' }}>Mingguan</option>
                                        <option value="Bulanan" {{ old('customer_company_salary_frequency', $evaluation->customer_company_salary_frequency) == 'Bulanan' ? 'selected' : '' }}>
                                            Bulanan</option>
                                    </select>
                                </div>
                                <div x-show="salaryFrequency !== 'Harian'">
                                    ...
                                    <div class="relative max-w-sm">
                                        ...
                                        <input type="date" id="customer_company_payday" name="customer_company_payday"
                                            value="{{ old('customer_company_payday', $evaluation->customer_company_payday ? date('Y-m-d', strtotime($evaluation->customer_company_payday)) : null) }}"
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="flex items-center justify-center w-full">
                                    <label for="business_legality_photo"
                                        ...
                                        <div class="flex flex-col items-center justify-center pt-5 pb-6 text-center px-4 {{ $evaluation->business_legality_path ? 'hidden' : '' }}"
                                        ...
                                        <img id="legality-preview"
                                            class="{{ $evaluation->business_legality_path ? '' : 'hidden' }} absolute h-full w-full object-cover"
                                            src="{{ $evaluation->business_legality_path ? route('media.evaluations', ['type' => 'photos', 'filename' => $evaluation->business_legality_path]) : '' }}" />
                                        <input id="business_legality_photo" name="business_legality_photo" type="file"
                                            ...
                                            data-placeholder="legality-placeholder" accept="image/*" />
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="flex items-center justify-center w-full">
                                    <label for="business_detail_1_photo"
                                        class="flex flex-col items-center justify-center w-full h-48 border-2 border-gray-300 border-dashed rounded-xl cursor-pointer bg-gray-50 hover:bg-gray-100 transition-colors relative overflow-hidden group">
                                        <div class="flex flex-col items-center justify-center pt-5 pb-6 text-center px-4 {{ $evaluation->business_detail_1_path ? 'hidden' : '' }}"
                                        ...
                                        <img id="detail1-preview"
                                            class="{{ $evaluation->business_detail_1_path ? '' : 'hidden' }} absolute h-full w-full object-cover"
                                            src="{{ $evaluation->business_detail_1_path ? route('media.evaluations', ['type' => 'photos', 'filename' => $evaluation->business_detail_1_path]) : '' }}" />
                                        <input id="business_detail_1_photo" name="business_detail_1_photo" type="file"
                                            ...
                                            data-placeholder="detail1-placeholder" accept="image/*" />
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="flex items-center justify-center w-full">
                                    <label for="business_detail_2_photo"
                                        class="flex flex-col items-center justify-center w-full h-48 border-2 border-gray-300 border-dashed rounded-xl cursor-pointer bg-gray-50 hover:bg-gray-100 transition-colors relative overflow-hidden group">
                                        <div class="flex flex-col items-center justify-center pt-5 pb-6 text-center px-4 {{ $evaluation->business_detail_2_path ? 'hidden' : '' }}"
                                        ...
                                        <img id="detail2-preview"
                                            class="{{ $evaluation->business_detail_2_path ? '' : 'hidden' }} absolute h-full w-full object-cover"
                                            src="{{ $evaluation->business_detail_2_path ? route('media.evaluations', ['type' => 'photos', 'filename' => $evaluation->business_detail_2_path]) : '' }}" />
                                        <input id="business_detail_2_photo" name="business_detail_2_photo" type="file"
                                            ...
                                            data-placeholder="detail2-placeholder" accept="image/*" />
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div class="space-y-4">
                                    ...
                                    <div id="map"></div>
                                    <div id="existing-map-preview"
                                        class="mb-2 {{ $evaluation->business_location_image_path ? '' : 'hidden' }}">
                                        <label class="block text-sm font-bold text-gray-700 mb-1">Gambar Peta
                                            Tersimpan</label>
                                        <img src="{{ $evaluation->business_location_image_path ? route('media.evaluations', ['type' => 'map', 'filename' => $evaluation->business_location_image_path]) : '' }}"
                                    ...
                                    <p class="text-[10px] text-gray-500 italic mt-2">
                                        * Klik pada peta untuk lokasi tepat, lalu klik "Ambil Gambar Peta Baru" untuk
                                        memperbarui.
                                    </p>
                                </div>
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <input type="text" id="business_longitude" name="business_longitude" readonly
                                                value="{{ old('business_longitude', $evaluation->business_longitude) }}"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 font-mono cursor-not-allowed"
                                                placeholder="Contoh: 112.4401329">
                                        </div>
                                    </div>

                                    <!-- Distance Alert -->
                                    <div id="distance-alert"
                                        class="hidden p-4 mt-4 text-sm rounded-lg flex items-center gap-3 transition-colors duration-300"
                                        role="alert">
                                        <svg class="flex-shrink-0 inline w-5 h-5" aria-hidden="true"
                                            xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                            <path
                                                d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5ZM9.5 4a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3ZM12 15H8a1 1 0 0 1 0-2h1v-3H8a1 1 0 0 1 0-2h2a1 1 0 0 1 1 1v4h1a1 1 0 0 1 0 2Z" />
                                        </svg>
                                        <div>
                                            <span class="font-bold">Jarak dari
                                                {{ auth()->user()->office_branch ?? 'Kantor Pusat' }}:</span>
                                            <span id="distance-value" class="font-mono font-bold text-base">0 km</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="space-y-4 pt-2">
                                        <div>
                                            ...
                                            <input type="text" id="business_province" name="business_province" readonly
                                                value="{{ old('business_province', $evaluation->business_province) }}"
                                        ...
                                        <div>
                                            ...
                                            <input type="text" id="business_regency" name="business_regency" readonly
                                                value="{{ old('business_regency', $evaluation->business_regency) }}"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 cursor-not-allowed">
                                        </div>
                                        <div>
                                            <label
                                            ...
                                            <input type="text" id="business_district" name="business_district" readonly
                                                value="{{ old('business_district', $evaluation->business_district) }}"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 cursor-not-allowed">
                                        </div>
                                        <div>
                                            ...
                                            <input type="text" id="business_village" name="business_village" readonly
                                                value="{{ old('business_village', $evaluation->business_village) }}"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 cursor-not-allowed">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4">
                                    ...
                                    <div class="sm:col-span-2 lg:col-span-1">
                                        ...
                                        <input type="text" x-model="loan.bank_name"
                                            :id="'external_loan_' + index + '_bank_name'"
                                    ...
                                    <div class="lg:col-span-1">
                                        ...
                                        <select x-model="loan.collectibility"
                                            :id="'external_loan_' + index + '_collectibility'"
                                    ...
                                    <div class="lg:col-span-1">
                                        ...
                                        <input type="date" x-model="loan.realization_date"
                                            ...
                                            :id="'external_loan_' + index + '_realization_date'"
                                    ...
                                    <div class="lg:col-span-1">
                                        ...
                                        <input type="date" x-model="loan.maturity_date" @change="calculateLoanTenor(index)"
                                            :id="'external_loan_' + index + '_maturity_date'"
                                    ...
                                    <div>
                                        ...
                                        <div class="relative rounded-md shadow-sm">
                                            ...
                                            <input type="text" x-model="loan.original_amount"
                                                ...
                                                :id="'external_loan_' + index + '_original_amount'"
                                    ...
                                    <div>
                                        ...
                                        <div class="relative rounded-md shadow-sm">
                                            ...
                                            <input type="text" x-model="loan.outstanding_balance"
                                                ...
                                                :id="'external_loan_' + index + '_outstanding_balance'"
                                        ...
                                        <div>
                                            ...
                                            <div class="relative rounded-md shadow-sm">
                                                <input type="number" x-model="loan.term_months"
                                                    ...
                                                    :id="'external_loan_' + index + '_term_months'"
                                        ...
                                        <div>
                                            ...
                                            <div class="relative rounded-md shadow-sm">
                                                <input type="number" step="0.01" x-model="loan.interest_rate"
                                                    @input="calculateInstallment(index)"
                                                    :id="'external_loan_' + index + '_interest_rate'"
                                    ...
                                    <div>
                                        ...
                                        <select x-model="loan.interest_method" @change="calculateInstallment(index)"
                                            :id="'external_loan_' + index + '_interest_method'"
                                    ...
                                    <div
                                        ...
                                        <div class="text-right">
                                            ...
                                            <input type="text" x-model="loan.installment_amount" readonly
                                                :id="'external_loan_' + index + '_installment_amount'"
                ...
                <div x-show="currentStep === 3" style="display: none;" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                        ...
                        <div class="bg-white p-4 rounded-xl border border-gray-200 shadow-sm">
                            ...
                            <p class="text-[9px] text-gray-500 mt-1 italic">Formula: (Angsuran + Angsuran Lain) / Net Cash
                                Flow</p>
                        </div>
                        ...
                        <div class="bg-white p-4 rounded-xl border border-gray-200 shadow-sm">
                            ...
                            <p class="text-[9px] text-gray-500 mt-1 italic">Formula: Total Pinjaman Eksternal / Total Aset
                            </p>
                        </div>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="divide-y divide-gray-200 bg-white">
                                ...
                                <tr class="hover:bg-gray-50 transition-colors group">
                                    ...
                                    <td class="whitespace-nowrap px-3 py-2">
                                        <input type="text" id="salary_before" x-model="salaryBefore"
                                            @input="updateCFValue('salaryBefore', $event.target.value)"
                                            class="block w-full rounded-lg border-gray-300 py-2 text-gray-900 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-right sm:text-sm bg-gray-50 focus:bg-white transition-all"
                                            placeholder="0">
                                        <input type="hidden" id="salary_before_hidden" name="cash_in_salary_before"
                                            x-model="salaryBefore">
                                    </td>
                                    <td class="whitespace-nowrap px-3 py-2">
                                        <input type="text" id="salary_after" x-model="salaryAfter"
                                            ...
                                            placeholder="0">
                                        <input type="hidden" id="salary_after_hidden" name="cash_in_salary_after"
                                            x-model="salaryAfter">
                                    </td>
                                </tr>
                                <tr class="hover:bg-gray-50 transition-colors group">
                                    ...
                                    <td class="whitespace-nowrap px-3 py-2">
                                        <input type="text" id="business_before" x-model="businessBefore"
                                            @input="updateCFValue('businessBefore', $event.target.value)"
                                            class="block w-full rounded-lg border-gray-300 py-2 text-gray-900 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-right sm:text-sm bg-gray-50 focus:bg-white transition-all"
                                            placeholder="0">
                                        <input type="hidden" id="business_before_hidden" name="cash_in_business_before"
                                            x-model="businessBefore">
                                    </td>
                                    <td class="whitespace-nowrap px-3 py-2">
                                        <input type="text" id="business_after" x-model="businessAfter"
                                            @input="updateCFValue('businessAfter', $event.target.value)"
                                            class="block w-full rounded-lg border-gray-300 py-2 text-gray-900 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 text-right sm:text-sm bg-gray-50 focus:bg-white transition-all"
                                            placeholder="0">
                                        <input type="hidden" id="business_after_hidden" name="cash_in_business_after"
                                            x-model="businessAfter">
                                    </td>
                                </tr>
                                ...
                                <tr class="hover:bg-gray-50 transition-colors group">
                                    ...
                                    <td class="whitespace-nowrap px-3 py-2">
                                        <input type="text" id="capital_injection" x-model="capitalInjection"
                                            @input="updateCFValue('capitalInjection', $event.target.value)"
                                            class="block w-full rounded-lg border-gray-300 py-2 text-gray-900 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 text-right sm:text-sm bg-gray-50 focus:bg-white transition-all"
                                            placeholder="0">
                                        <input type="hidden" id="capital_injection_hidden" name="capital_injection_amount"
                                            x-model="capitalInjection">
                                    </td>
                                </tr>
                                ...
                                @foreach($hhFields as $field)
                                    <tr class="hover:bg-gray-50 transition-colors group">
                                        ...
                                        <td class="whitespace-nowrap px-3 py-2">
                                            <input type="text" id="{{ $field['name'] }}_before"
                                                ...
                                                placeholder="0">
                                            <input type="hidden" id="{{ $field['name'] }}_before_hidden"
                                                name="{{ $field['name'] }}_before" x-model="{{ $field['model'] }}Before">
                                        </td>
                                        <td class="whitespace-nowrap px-3 py-2">
                                            <input type="text" id="{{ $field['name'] }}_after"
                                                ...
                                                placeholder="0">
                                            <input type="hidden" id="{{ $field['name'] }}_after_hidden"
                                                name="{{ $field['name'] }}_after" x-model="{{ $field['model'] }}After">
                                        </td>
                                    </tr>
                                @endforeach
                                ...
                                <tr class="hover:bg-gray-50 transition-colors group">
                                    ...
                                    <td class="whitespace-nowrap px-3 py-2">
                                        <input type="text" id="other_expenses_before" x-model="otherExpBefore"
                                            @input="updateCFValue('otherExpBefore', $event.target.value)"
                                            class="block w-full rounded-lg border-gray-300 py-2 text-gray-900 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-right sm:text-sm bg-gray-50 focus:bg-white transition-all"
                                            placeholder="0">
                                        <input type="hidden" id="other_expenses_before_hidden" name="other_expenses_before"
                                            x-model="otherExpBefore">
                                    </td>
                                    <td class="whitespace-nowrap px-3 py-2">
                                        <input type="text" id="other_expenses_after" x-model="otherExpAfter"
                                            @input="updateCFValue('otherExpAfter', $event.target.value)"
                                            class="block w-full rounded-lg border-gray-300 py-2 text-gray-900 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 text-right sm:text-sm bg-gray-50 focus:bg-white transition-all"
                                            placeholder="0">
                                        <input type="hidden" id="other_expenses_after_hidden" name="other_expenses_after"
                                            x-model="otherExpAfter">
                                    </td>
                                </tr>
                                ...
                                <tr class="bg-white border-t border-gray-200">
                                    <td
                                        ...
                                        <div
                                            ...
                                            <input type="number" id="rpc_ratio" step="1" name="rpc_ratio" x-model="rpcRatio"
                            ...
                            <tbody class="divide-y divide-gray-200 bg-white">
                                ...
                                @foreach($loanCosts as $cost)
                                    <tr class="hover:bg-amber-50/40 transition-colors group">
                                        <td
                                            ...
                                            <div
                                                ...
                                                <input type="number" step="0.01"
                                                    id="{{ ($cost['name'] == 'loan_provision_cost') ? 'loan_provision_rate' : 'loan_admin_rate' }}"
                                        ...
                                        <td class="whitespace-nowrap px-3 py-2">
                                            <input type="text" id="{{ $cost['name'] }}" name="{{ $cost['name'] }}"
                                                x-model="{{ $cost['model'] }}Amount"
                                ...
                                <tr class="hover:bg-orange-50/50 transition-colors group">
                                    <td
                                        ...
                                        <div
                                            class="ml-2 flex items-center bg-white rounded-lg border border-gray-200 px-1 shadow-sm">
                                            <input type="number" id="interest_rate" step="0.01" name="interest_rate"
                                ...
                                <tr class="hover:bg-orange-50/50 transition-colors group">
                                    ...
                                    <td colspan="2" class="whitespace-nowrap px-3 py-2">
                                        <input type="number" id="loan_tenor" name="loan_tenor" x-model="loanTerm"
                            ...
                            <div
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                    <div class="md:col-span-2">
                                        ...
                                        <select :id="'collateral_' + index + '_type'" :name="'collaterals['+index+'][type]'"
                                            x-model="col.type"
                                            class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 shadow-sm">
                                    ...
                                    <div>
                                        <label class="block mb-1 text-xs font-bold text-gray-500 uppercase">Nama
                                            Pemilik</label>
                                        <input type="text" :id="'collateral_' + index + '_owner_name'"
                                            :name="'collaterals['+index+'][owner_name]'" x-model="col.owner_name"
                                            class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 shadow-sm">
                                    </div>
                                    ...
                                    <div>
                                        <label class="block mb-1 text-xs font-bold text-gray-500 uppercase">No. KTP
                                            Pemilik</label>
                                        <input type="text" :id="'collateral_' + index + '_owner_ktp'"
                                            :name="'collaterals['+index+'][owner_ktp]'" x-model="col.owner_ktp"
                                            class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 shadow-sm">
                                    </div>
                                    ...
                                    <div>
                                        <label class="block mb-1 text-xs font-bold text-gray-500 uppercase">Jenis
                                            Bukti</label>
                                        <select :id="'collateral_' + index + '_proof_type'"
                                            :name="'collaterals['+index+'][proof_type]'" x-model="col.proof_type"
                                            class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 shadow-sm">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" :id="'collateral_' + index + '_proof_number'"
                                            :name="'collaterals['+index+'][proof_number]'" x-model="col.proof_number"
                                            class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 shadow-sm">
                                    </div>
                                    <div class="md:col-span-2">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="text" :id="'collateral_' + index + '_market_value'"
                                                :name="'collaterals['+index+'][market_value]'" x-model="col.market_value"
                                    ...
                                    <div x-show="col.type === 'certificate'"
                                        ...
                                        <div>
                                            <label class="block mb-1 text-xs font-bold text-gray-500 uppercase">Luas Tanah
                                                (m2)</label>
                                            <input type="number" :id="'collateral_' + index + '_land_area'"
                                                :name="'collaterals['+index+'][land_area]'" x-model="col.land_area"
                                                class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 shadow-sm">
                                        </div>
                                        <div>
                                            <label class="block mb-1 text-xs font-bold text-gray-500 uppercase">Luas
                                                Bangunan (m2)</label>
                                            <input type="number" :id="'collateral_' + index + '_building_area'"
                                                :name="'collaterals['+index+'][building_area]'" x-model="col.building_area"
                                                class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 shadow-sm">
                                        </div>
                                        <div>
                                            <label class="block mb-1 text-xs font-bold text-gray-500 uppercase">Peruntukan
                                                Tanah</label>
                                            <input type="text" :id="'collateral_' + index + '_peruntukan_tanah'"
                                                :name="'collaterals['+index+'][peruntukan_tanah]'"
                                        ...
                                        <div>
                                            <label class="block mb-1 text-xs font-bold text-gray-500 uppercase">Lebar Jalan
                                                (m)</label>
                                            <input type="number" step="0.01" :id="'collateral_' + index + '_lebar_jalan'"
                                                :name="'collaterals['+index+'][lebar_jalan]'" x-model="col.lebar_jalan"
                                                class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 shadow-sm">
                                        </div>
                                        <div>
                                            <label class="block mb-1 text-xs font-bold text-gray-500 uppercase">Kondisi
                                                Bangunan</label>
                                            <input type="text" :id="'collateral_' + index + '_kondisi_bangunan'"
                                                :name="'collaterals['+index+'][kondisi_bangunan]'"
                                        ...
                                        <div>
                                            <label class="block mb-1 text-xs font-bold text-gray-500 uppercase">Material
                                                Pondasi</label>
                                            <input type="text" :id="'collateral_' + index + '_material_pondasi'"
                                                :name="'collaterals['+index+'][material_pondasi]'"
                                        ...
                                        <div>
                                            <label class="block mb-1 text-xs font-bold text-gray-500 uppercase">Material
                                                Tembok</label>
                                            <input type="text" :id="'collateral_' + index + '_material_tembok'"
                                                :name="'collaterals['+index+'][material_tembok]'"
                                        ...
                                        <div>
                                            <label class="block mb-1 text-xs font-bold text-gray-500 uppercase">Material
                                                Atap</label>
                                            <input type="text" :id="'collateral_' + index + '_material_atap'"
                                                :name="'collaterals['+index+'][material_atap]'" x-model="col.material_atap"
                                                class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 shadow-sm">
                                        </div>
                                        <div>
                                            <label class="block mb-1 text-xs font-bold text-gray-500 uppercase">Material
                                                Kusen</label>
                                            <input type="text" :id="'collateral_' + index + '_material_kusen'"
                                                :name="'collaterals['+index+'][material_kusen]'"
                                        ...
                                        <div>
                                            <label class="block mb-1 text-xs font-bold text-gray-500 uppercase">Material
                                                Daun Pintu</label>
                                            <input type="text" :id="'collateral_' + index + '_material_daun_pintu'"
                                                :name="'collaterals['+index+'][material_daun_pintu]'"
                                        ...
                                        <div class="md:col-span-2">
                                            <label class="block mb-1 text-xs font-bold text-gray-500 uppercase">Alamat
                                                Lokasi</label>
                                            <textarea :id="'collateral_' + index + '_location_address'"
                                                :name="'collaterals['+index+'][location_address]'"
                                            ...
                                            <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
                                                ...
                                                <template
                                                    ...
                                                    <div class="space-y-2"
                                                        x-init="
                                                                                                                                                    $nextTick(() => {
                                                                                                                                                        const img = getCollateralImage(col, imgIdx);
                                                                                                                                                        if(img) {
                                                                                                                                                            const p = document.getElementById('col-preview-' + index + '-' + imgIdx);
                                                                                                                                                            const ph = document.getElementById('col-placeholder-' + index + '-' + imgIdx);
                                                                                                                                                            if(p) { 
                                                                                                                                                                p.src = '{{ route('media.evaluations', ['type' => 'collaterals', 'filename' => 'PLACEHOLDER']) }}'.replace('PLACEHOLDER', img);
                                                        ...
                                                        <div class="flex items-center justify-center w-full">
                                                            <label :for="'col_img_' + index + '_' + imgIdx"
                                                                ...
                                                                <input type="hidden"
                                                                    :id="'collateral_' + index + '_existing_image_' + imgIdx"
                                                                    :name="col.type === 'certificate' ? 'collaterals['+index+'][existing_images]['+imgIdx+']' : ''"
                                                                    :value="getCollateralImage(col, imgIdx)">
                                                            </label>
                                                        </div>
                                                    </div>
                                                </template>
                                    ...
                                    <div x-show="col.type === 'vehicle'"
                                        ...
                                        <div>
                                            <label class="block mb-1 text-xs font-bold text-gray-500 uppercase">Merk
                                                Kendaraan</label>
                                            <input type="text" :id="'collateral_' + index + '_brand'"
                                                :name="'collaterals['+index+'][brand]'" x-model="col.brand"
                                        ...
                                        <div>
                                            <label class="block mb-1 text-xs font-bold text-gray-500 uppercase">Tipe /
                                                Model</label>
                                            <input type="text" :id="'collateral_' + index + '_model'"
                                                :name="'collaterals['+index+'][model]'" x-model="col.model"
                                        ...
                                        <div>
                                            <label class="block mb-1 text-xs font-bold text-gray-500 uppercase">Tahun
                                                Pembuatan</label>
                                            <input type="number" :id="'collateral_' + index + '_year'"
                                                :name="'collaterals['+index+'][year]'" x-model="col.year"
                                                class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 shadow-sm">
                                        </div>
                                        <div>
                                            <label
                                                class="block mb-1 text-xs font-bold text-gray-500 uppercase">Warna</label>
                                            <input type="text" :id="'collateral_' + index + '_color'"
                                                :name="'collaterals['+index+'][color]'" x-model="col.color"
                                                class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 shadow-sm">
                                        </div>
                                        <div>
                                            <label class="block mb-1 text-xs font-bold text-gray-500 uppercase">Nomor
                                                Polisi</label>
                                            <input type="text" :id="'collateral_' + index + '_police_number'"
                                                :name="'collaterals['+index+'][police_number]'" x-model="col.police_number"
                                                class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 shadow-sm">
                                        </div>
                                        <div>
                                            <label class="block mb-1 text-xs font-bold text-gray-500 uppercase">No.
                                                Rangka</label>
                                            <input type="text" :id="'collateral_' + index + '_chassis_number'"
                                                :name="'collaterals['+index+'][chassis_number]'"
                                        ...
                                        <div>
                                            <label class="block mb-1 text-xs font-bold text-gray-500 uppercase">No.
                                                Mesin</label>
                                            <input type="text" :id="'collateral_' + index + '_engine_number'"
                                                :name="'collaterals['+index+'][engine_number]'" x-model="col.engine_number"
                                                class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 shadow-sm">
                                        </div>
                                                    ...
                                                    <div class="space-y-2"
                                                        x-init="
                                                                                                                                                    $nextTick(() => {
                                                                                                                                                        const img = getCollateralImage(col, imgIdx);
                                                                                                                                                        if(img) {
                                                                                                                                                            const p = document.getElementById('col-veh-preview-' + index + '-' + imgIdx);
                                                                                                                                                            const ph = document.getElementById('col-veh-placeholder-' + index + '-' + imgIdx);
                                                                                                                                                            if(p) { 
                                                                                                                                                                p.src = '{{ route('media.evaluations', ['type' => 'collaterals', 'filename' => 'PLACEHOLDER']) }}'.replace('PLACEHOLDER', img); 
                                                                                                                                                                p.classList.remove('hidden'); 
                                                                                                                                                            }
                                                        ...
                                                        <div class="flex items-center justify-center w-full">
                                                            <label :for="'col_veh_img_' + index + '_' + imgIdx"
                                                                ...
                                                                <!-- Hidden Input for Existing Image -->
                                                                <input type="hidden"
                                                                    :id="'collateral_' + index + '_existing_vehicle_image_' + imgIdx"
                                                                    :name="col.type === 'vehicle' ? 'collaterals['+index+'][existing_images]['+imgIdx+']' : ''"
                                                                    :value="getCollateralImage(col, imgIdx)">
                                                            </label>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="md:col-span-2 mt-4 pt-4 border-t border-gray-200">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            ...
                                            <div>
                                                ...
                                                <input type="text" :id="'collateral_' + index + '_latitude'"
                                                    :name="'collaterals['+index+'][latitude]'" x-model="col.latitude"
                                                    readonly
                                            ...
                                            <div>
                                                ...
                                                <input type="text" :id="'collateral_' + index + '_longitude'"
                                                    :name="'collaterals['+index+'][longitude]'" x-model="col.longitude"
                                                    readonly
                                                    class="bg-gray-100 border border-gray-300 text-gray-500 text-xs rounded-lg block w-full p-2.5">
                                            </div>
                                            ...
                                            <div>
                                                <label class="block mb-1 text-xs font-bold text-gray-500 uppercase">Desa /
                                                    Kelurahan</label>
                                                <input type="text" :id="'collateral_' + index + '_village'"
                                                    :name="'collaterals['+index+'][village]'" x-model="col.village" readonly
                                            ...
                                            <div>
                                                ...
                                                <input type="text" :id="'collateral_' + index + '_district'"
                                                    :name="'collaterals['+index+'][district]'" x-model="col.district"
                                                    readonly
                                                    class="bg-gray-100 border border-gray-300 text-gray-700 text-sm rounded-lg block w-full p-2.5">
                                            </div>
                                            <div>
                                                <label
                                                    ...
                                                    Kota</label>
                                                <input type="text" :id="'collateral_' + index + '_regency'"
                                                    :name="'collaterals['+index+'][regency]'" x-model="col.regency" readonly
                                                    class="bg-gray-100 border border-gray-300 text-gray-700 text-sm rounded-lg block w-full p-2.5">
                                            </div>
                                            <div>
                                                <label
                                                    class="block mb-1 text-xs font-bold text-gray-500 uppercase">Provinsi</label>
                                                <input type="text" :id="'collateral_' + index + '_province'"
                                                    :name="'collaterals['+index+'][province]'" x-model="col.province"
                                                    readonly
                                                    class="bg-gray-100 border border-gray-300 text-gray-700 text-sm rounded-lg block w-full p-2.5">
                                            </div>
                                        </div>
                ...
                <div x-show="currentStep === 6" style="display: none;" class="space-y-6">
                    <h2 class="text-xl font-bold text-gray-900 flex items-center gap-3 border-b pb-4">
                        ...
                        Bagian 6 : Analisa 5C (Character, Capacity, Capital, Collateral, Condition)
                    </h2>
        ...
        @php
            // Calculate proposedLimit for Kabag approval validation
            $approvalLoanAmount = $evaluation->loan_amount ?? 0;
            $approvalInterestRate = $evaluation->loan_interest_rate ?? 0;
            $approvalTenor = $evaluation->loan_term_months ?? 0;

            $approvalNetIncome = max(0, ($evaluation->cash_in_total_before ?? 0) - ($evaluation->cash_out_total_before ?? 0));
            $approvalRpcRatioVal = ($evaluation->rpc_ratio ?? 0) / 100;
            $approvalIncomeRpcLimit = ($evaluation->net_cash_flow_before ?? 0) * $approvalRpcRatioVal;

            $approvalNumerator = ($approvalNetIncome > $approvalIncomeRpcLimit) ? $approvalIncomeRpcLimit : $approvalNetIncome;

            $approvalRatePerMonth = $approvalInterestRate / 1200;
            $approvalLimit = 0;
            if ($approvalTenor > 0) {
                if ($evaluation->loan_type === 'Pinjaman Anuitas') {
                    if ($approvalRatePerMonth == 0) {
                        $approvalLimit = $approvalNumerator * $approvalTenor;
                    } else {
                        $pvFactor = (1 - pow(1 + $approvalRatePerMonth, -$approvalTenor)) / $approvalRatePerMonth;
                        $approvalLimit = $approvalNumerator * $pvFactor;
                    }
                } elseif ($evaluation->loan_type === 'Pinjaman Musiman') {
                    if ($approvalRatePerMonth > 0) {
                        $approvalLimit = $approvalNumerator / $approvalRatePerMonth;
                    }
                } else {
                    $approvalLimit = ($approvalNumerator * $approvalTenor) / (1 + ($approvalRatePerMonth * $approvalTenor));
                }
            }
            $approvalMaxLoanLimit = floor($approvalLimit / 1000000) * 1000000;
            $proposedLimit = ($approvalMaxLoanLimit > $approvalLoanAmount) ? $approvalLoanAmount : $approvalMaxLoanLimit;
        @endphp

        @if(auth()->user()->can('approve evaluations') && $evaluation->approval_status === 'pending')
            <!-- Kabag Approval Panel -->
            <div class="mt-8 bg-white shadow-xl rounded-2xl border border-gray-200 overflow-hidden">
                <div class="bg-gray-50 border-b border-gray-200 px-6 py-4">
                    <h3 class="text-lg font-bold text-gray-900">Panel Persetujuan (Kabag)</h3>
                    <p class="text-sm text-gray-500 mt-1">Maks. Plafon yang direkomendasikan: <strong class="text-blue-700">Rp
                            {{ number_format($proposedLimit, 0, ',', '.') }}</strong></p>
                </div>
                <div class="p-6">
                    <form action="{{ route('evaluations.approval', $evaluation->id) }}" method="POST" id="approvalForm">
                        @csrf
                        <input type="hidden" name="approval_status" id="approvalStatusInput" value="">
                        <input type="hidden" id="proposedLimitValue" value="{{ $proposedLimit }}">

                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Plafon Disetujui (Rp)</label>
                                <input type="text" name="approved_amount" id="approved_amount" x-data
                                    x-mask:dynamic="$money($input, '.', '')"
                                    value="{{ old('approved_amount', floatval($proposedLimit)) }}"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                    oninput="checkApprovedAmount()">
                                <div id="approvedAmountWarning"
                                    class="hidden mt-2 p-2 bg-yellow-50 border border-yellow-300 rounded-lg">
                                    <p class="text-xs text-yellow-800 font-medium">⚠️ Jumlah melebihi batas rekomendasi maksimum
                                        (Rp <span
                                            id="proposedLimitDisplay">{{ number_format($proposedLimit, 0, ',', '.') }}</span>)
                                        Harap berhati - hati!
                                    </p>
                                </div>
                            </div>
                            <div>
                                ...
                                <input type="number" name="approved_tenor"
                                    value="{{ old('approved_tenor', $evaluation->loan_term_months) }}"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Suku Bunga Disetujui (%)</label>
                                <input type="number" step="0.01" name="approved_interest_rate"
                                    value="{{ old('approved_interest_rate', $evaluation->loan_interest_rate) }}"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                            </div>
                        </div>

                        <div class="mb-6">
                            <label class="block text-sm font-medium text-gray-700 mb-2">Catatan Persetujuan / Penolakan</label>
                            <input id="approval_note" type="hidden" name="approval_note">
                            <trix-editor input="approval_note" class="trix-content bg-white min-h-[150px]"></trix-editor>
                        </div>

                        <div class="flex items-center justify-end gap-3 pt-4 border-t border-gray-200">
                            <button type="button" onclick="submitApproval('rejected')"
                                class="text-white bg-red-600 hover:bg-red-700 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center transition-colors">
                                Tolak Evaluasi
                            </button>
                            <button type="button" onclick="submitApproval('approved')"
                                class="text-white bg-green-600 hover:bg-green-700 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center transition-colors">
                                Setujui Evaluasi
                            </button>
                        </div>
                    </form>
        ...
        @elseif(in_array($evaluation->approval_status, ['approved', 'rejected']))
            @php
                $hoursSinceDecision = now()->diffInHours($evaluation->updated_at);
                $canRevoke = auth()->user()->can('approve evaluations') && $hoursSinceDecision <= 24;
                $hoursRemaining = max(0, 24 - $hoursSinceDecision);
            @endphp
            <div
                class="mt-8 bg-{{ $evaluation->approval_status === 'approved' ? 'green' : 'red' }}-50 border border-{{ $evaluation->approval_status === 'approved' ? 'green' : 'red' }}-200 rounded-xl p-6">
                <div class="flex items-start justify-between">
                    <div>
                        <h3
                            class="text-lg font-bold text-{{ $evaluation->approval_status === 'approved' ? 'green' : 'red' }}-800 mb-2">
                            Evaluasi {{ $evaluation->approval_status === 'approved' ? 'Disetujui' : 'Ditolak' }}
                        </h3>
                        <div
                            class="text-sm text-{{ $evaluation->approval_status === 'approved' ? 'green' : 'red' }}-900 prose prose-sm max-w-none">
                            {!! $evaluation->approval_note ?? 'Tidak ada catatan diberikan.' !!}
                        </div>
                    </div>
                    @if($canRevoke)
                        <form action="{{ route('evaluations.revoke', $evaluation->id) }}" method="POST" id="revokeApprovalForm">
                            @csrf
                            <button type="button" onclick="confirmRevokeApproval()"
                                class="flex-shrink-0 ml-4 text-white bg-orange-500 hover:bg-orange-600 focus:ring-4 focus:ring-orange-300 font-medium rounded-lg text-sm px-4 py-2 transition-colors shadow-sm">
                                ↩ Batalkan Keputusan
                            </button>
                            <p class="text-xs text-gray-500 mt-1 text-right">Sisa waktu: {{ $hoursRemaining }} jam</p>
                        </form>
                    @endif
                </div>
            </div>
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                ...
                                <div>
                                    <div class="relative mb-4">
                                        ...
                                        <input type="text" id="customer_search_input" x-model="search"
    ...
    @push('scripts')
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                // --- Form Capture Logic (Refactored with Promises) ---

                // 1. Core Capture Function (Returns Promise)
                window.getMapSnapshot = function () {
                    return new Promise((resolve, reject) => {
                        ...
                        setTimeout(() => {
                            html2canvas(mapElement, {
                                ...
                                backgroundColor: '#ffffff',
                                onclone: (clonedDoc) => {
                                    // Cleanup styles for Tailwind v4 compatibility
                ...
                // 2. Manual Capture Wrapper (Backward Compatibility)
                window.captureMapManual = function () {
                    ...
                    window.getMapSnapshot()
                        ...
                        .catch(err => {
                            ...
                            Swal.fire('Error', 'Gagal memproses gambar: ' + (err.message || err), 'error');
                        });
                };

                // 3. Submit Logic with Auto-Capture
                window.captureMapAndSubmit = function (formElement) {
                    // Check if we already have an image or if map is hidden
                    const existingImage = document.getElementById('location_image').value;
                    const mapElement = document.getElementById('map');
                    const isMapVisible = mapElement && mapElement.offsetParent !== null;

                    if ((existingImage && existingImage.length > 100) || !isMapVisible) {
                        formElement.submit();
                        return;
                    }
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            Swal.fire({
                                title: 'Memproses...',
                                text: 'Sedang mengambil snapshot peta dan menyimpan...',
                                allowOutsideClick: false,
                                didOpen: () => Swal.showLoading()
                            });
                            ...
                            window.getMapSnapshot()
                                ...
                                .catch(err => {
                                    ...
                                    Swal.fire({
                                        icon: 'error',
                                        title: 'Gagal',
                                        text: 'Gagal mengambil gambar peta otomatis. Silakan coba ambil manual.',
    ...
    @push('scripts')
        ...
        <script>
            function confirmRevokeApproval() {
                Swal.fire({
                    ...
                    text: "Keputusan persetujuan/penolakan akan dibatalkan dan evaluasi kembali ke status pending.",
                    icon: 'warning',
                    showCancelButton: true,
                    ...
                    if (result.isConfirmed) {
                        document.getElementById('revokeApprovalForm').submit();
                    }
                });
            }

            function getApprovedAmountNumeric() {
                const raw = document.getElementById('approved_amount')?.value || '0';
                return parseFloat(raw.replace(/\./g, '').replace(',', '.')) || 0;
            }

            function checkApprovedAmount() {
                const proposedLimit = parseFloat(document.getElementById('proposedLimitValue')?.value) || 0;
                const approvedAmount = getApprovedAmountNumeric();
                const warningEl = document.getElementById('approvedAmountWarning');
                if (warningEl) {
                    if (approvedAmount > proposedLimit && proposedLimit > 0) {
            ...
            function submitApproval(status) {
                document.getElementById('approvalStatusInput').value = status;

                const proposedLimit = parseFloat(document.getElementById('proposedLimitValue')?.value) || 0;
                const approvedAmount = getApprovedAmountNumeric();

                // If approving and amount exceeds proposed limit, show extra warning
                if (status === 'approved' && approvedAmount > proposedLimit && proposedLimit > 0) {
                    const formattedLimit = new Intl.NumberFormat('id-ID').format(proposedLimit);
                    const formattedAmount = new Intl.NumberFormat('id-ID').format(approvedAmount);
                    Swal.fire({
                        title: 'Plafon Melebihi Batas Rekomendasi!',
                        html: `Plafon disetujui (<strong>Rp ${formattedAmount}</strong>) melebihi batas rekomendasi maksimum (<strong>Rp ${formattedLimit}</strong>).<br><br>Apakah Anda yakin ingin melanjutkan?`,
                        icon: 'warning',
                        showCancelButton: true,
                        confirmButtonColor: '#d97706',
                        cancelButtonColor: '#6b7280',
                        confirmButtonText: 'Ya, Lanjutkan Persetujuan',
                        cancelButtonText: 'Batal'
                    }).then((result) => {
                        if (result.isConfirmed) {
                ...
                const msg = status === 'approved' ? 'Kirim Persetujuan Evaluasi ini?' : 'Tolak Evaluasi ini?';
                Swal.fire({
                    title: msg,
            ...
            // Check on page load in case of old() value
            document.addEventListener('DOMContentLoaded', function () {
                if (document.getElementById('approved_amount')) {
                    checkApprovedAmount();
                }
            });
        </script>
        ...
        @if(isset($readonly) && $readonly)
            <script>
                document.addEventListener('DOMContentLoaded', function () {
                    // Disable all inputs in the evaluation form (but NOT in the approval form)
                    const evalForm = document.getElementById('evaluation-form');
                    if (evalForm) {
                        evalForm.querySelectorAll('input, select, textarea').forEach(function (el) {
                            el.setAttribute('disabled', 'disabled');
                        });
                        // Also hide file upload buttons
                        evalForm.querySelectorAll('input[type="file"]').forEach(function (el) {
                            el.closest('div')?.style.setProperty('display', 'none');
                        });
                        // Hide the submit button
                        evalForm.querySelectorAll('button[type="submit"], button[type="button"]').forEach(function (btn) {
                            if (btn.textContent.includes('SIMPAN') || btn.textContent.includes('Selanjutnya')) {
